# Method for Bypassing FACEBOOK Moderation via Language Launch 🔥
...
- Scheduling the launch (of ad sets) for the start of the new day according to the account's time zone.
- Selecting the country you need to target + the Antarctica geo.
- During periods with many Rejections, if you are using many duplicate ads, you should uniqueize the ad creative (make minimal changes, update metadata, etc.).
...
## Step 3: Add “White” creatives to your ads
...
![White Creatives](/img/4.9/image3.webp)

## Step 4: Enable Language Settings

Scroll to the **"Languages"** section and enable it.

![Languages Section](/img/4.9/image4.webp)

## Step 5: Configure Language Strategy
